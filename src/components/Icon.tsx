...
export const Search = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
  ({ width = 24, height = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const SearchFilled = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
  ({ width = 24, height = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
      ...
      {...props}
    >
      <path d="M11.5 20C16.1944 20 20 16.1944 20 11.5C20 6.80558 16.1944 3 11.5 3C6.80558 3 3 6.80558 3 11.5C3 16.1944 6.80558 20 11.5 20Z" />
      <path d="M21 21L17.5001 17.5M20 11.5C20 16.1944 16.1944 20 11.5 20C6.80558 20 3 16.1944 3 11.5C3 6.80558 6.80558 3 11.5 3C16.1944 3 20 6.80558 20 11.5Z" />
    </svg>
  )
)
...
export const BookOpen = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
  ({ width = 24, height = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const BookOpenFilled = React.forwardRef<SVGSVGElement, React.SVGProps<SVGSVGElement>>(
  ({ width = 24, height = 24, strokeWidth = 2, ...props }, ref) => (
    <svg
      ref={ref}
      xmlns="http://www.w3.org/2000/svg"
...
export const SearchFilledIcon = SearchFilled

export const BookOpenIcon = BookOpen
export const BookOpenFilledIcon = BookOpenFilled
