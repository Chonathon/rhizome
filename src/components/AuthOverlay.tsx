        ...
        <DialogHeader >
         ...
         <form>
           <div className="grid gap-8 py-4">
             {/* OAuth */}
             <div className="flex flex-row sm:flex-col gap-4" hidden={signedIn}>
             ...
             <div className="flex flex-row sm:flex-col gap-4" hidden={!signedIn}>
               ...
               <Button className="flex-1 sm:p-2 p-4" variant="outline" size={isMobile ? "xl" : "default"} type="button"
                       onClick={() => onChangePassword(password, email)}>
                 Change Password
               </Button>
               <Button className="flex-1 sm:p-2 p-4" variant="outline" size={isMobile ? "xl" : "default"} type="button"
                       onClick={() => onDeleteAccount(password && password.length ? password : undefined)}>
                 Delete Account
               </Button>
             </div>
             {/* Divider */}
             ...
             <div className="text-center text-sm">
               ...
               <a href="#" className="underline underline-offset-4" onClick={() => onSignIn(email, password)}>
                 Log in
               </a>
             </div>
           </div>
