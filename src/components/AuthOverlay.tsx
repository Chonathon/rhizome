...
function AuthOverlay({ onSignUp, onSignInSocial, onSignIn, onForgotPassword, onLastFMPreview, onLastFMConnect }: AuthOverlayProps) {
  ...
  const isLfmStep = mode === "connect-lfm";
  ...
  const handleSocialAuth = async (social: Social) => {
