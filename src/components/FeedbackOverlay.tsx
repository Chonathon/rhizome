...
function FeedbackOverlay() {
    ...
    return (
        <DialogDrawer
          ...
          description="We're just getting started. Let us know how we can improve Rhizome!"
          contentClassName="bg-card max-h-[calc(100dvh-3rem)] overflow-y-auto sm:max-w-lg"
          footer={
            <>
              ...
              <Button
                className="flex-1"
                onClick={() => toast.success('Got it. Thanks for the tip!')}
                type="submit"
                disabled={true}
              >
                Submit
